class ImagePath {
  static String dokanLogo = "assets/img/dokan_logo.svg";
  static String placeHolder = "assets/img/placeholder.png";
  static String facebook = "assets/img/facebook.svg";
  static String google = "assets/img/google.png";
  static String email = "assets/img/email.svg";
